...
export const propertyTypes = ['House', 'Apartment', 'Villa', 'Boutique Hotel', 'Cabin', 'Treehouse', 'Boat', 'Farm Stay'];
export const amenities = ['Pool', 'Hot Tub', 'Gym', 'Parking', 'Wifi', 'Kitchen', 'Air Conditioning', 'Washer'];
...
export async function saveSearchToSupabaseAndNavigate(searchQueryJson: string): Promise<void> {
  try {
